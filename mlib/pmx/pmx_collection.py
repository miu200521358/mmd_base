...
class PmxModel(BaseHashModel):
    ...
    def replace_standard_weights(self, bone_names: list[str]) -> None:
        ...
        if "右腕捩" in bone_names and self.bones.exists(("右腕", "右腕捩", "右腕捩1", "右腕捩2", "右腕捩3", "右ひじ")):
            self.separate_weights("右腕", "右腕捩1", 0.3, ("右腕",))
            self.separate_weights("右腕捩1", "右腕捩2", 0.3, ("右腕", "右腕捩1"))
            self.separate_weights("右腕捩2", "右腕捩3", 0.3, ("右腕", "右腕捩1", "右腕捩2"))
            self.separate_weights("右腕捩3", "右ひじ", 0.2, ("右腕", "右腕捩1", "右腕捩2", "右腕捩3"))
        if "左腕捩" in bone_names and self.bones.exists(("左腕", "左腕捩", "左腕捩1", "左腕捩2", "左腕捩3", "左ひじ")):
            self.separate_weights("左腕", "左腕捩1", 0.3, ("左腕",))
            self.separate_weights("左腕捩1", "左腕捩2", 0.3, ("左腕", "左腕捩1"))
            self.separate_weights("左腕捩2", "左腕捩3", 0.3, ("左腕", "左腕捩1", "左腕捩2"))
        ...
        if "右手捩" in bone_names and self.bones.exists(("右ひじ", "右手捩", "右手捩1", "右手捩2", "右手捩3", "右手首")):
            ...
            self.separate_weights("右手捩1", "右手捩2", 0.3, ("右ひじ", "右手捩1"))
            self.separate_weights("右手捩2", "右手捩3", 0.3, ("右ひじ", "右手捩1", "右手捩2"))
            self.separate_weights("右手捩3", "右手首", 0.2, ("右ひじ", "右手捩1", "右手捩2", "右手捩3"))
        if "左手捩" in bone_names and self.bones.exists(("左ひじ", "左手捩", "左手捩1", "左手捩2", "左手捩3", "左手首")):
            self.separate_weights("左ひじ", "左手捩1", 0.0, ("左ひじ",))
            self.separate_weights("左手捩1", "左手捩2", 0.3, ("左ひじ", "左手捩1"))
            self.separate_weights("左手捩2", "左手捩3", 0.3, ("左ひじ", "左手捩1", "左手捩2"))
            self.separate_weights("左手捩3", "左手首", 0.2, ("左ひじ", "左手捩1", "左手捩2", "左手捩3"))
