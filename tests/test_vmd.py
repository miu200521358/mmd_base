...
def test_read_by_filepath_ok_leg_ik1() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes["左つま先"][29]["下半身"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.368843, 10.614175, 2.532657]),
        bone_matrixes["左つま先"][29]["左足"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.983212, 6.945313, 0.487476]),
        bone_matrixes["左つま先"][29]["左ひざ"].position.vector,
        rtol=0.03,
        atol=0.03,
    ).all()
    assert np.isclose(
        np.array([-0.345842, 2.211842, 2.182894]),
        bone_matrixes["左つま先"][29]["左足首"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.109262, -0.025810, 1.147780]),
        bone_matrixes["左つま先"][29]["左つま先"].position.vector,
        rtol=0.03,
        atol=0.03,
    ).all()
...
def test_read_by_filepath_ok_leg_ik2() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes["左つま先"][3152]["下半身"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([7.370017, 10.665785, 2.963280]),
        bone_matrixes["左つま先"][3152]["左足"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([9.282883, 6.689319, 2.96825]),
        bone_matrixes["左つま先"][3152]["左ひざ"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([4.115521, 7.276527, 2.980609]),
        bone_matrixes["左つま先"][3152]["左足首"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.931355, 6.108739, 2.994883]),
        bone_matrixes["左つま先"][3152]["左つま先"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
...
def test_read_by_filepath_ok_leg_ik3() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes["左つま先"][60]["下半身"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.927524, 10.550287, -1.218106]),
        bone_matrixes["左つま先"][60]["左足"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.263363, 7.061642, -3.837192]),
        bone_matrixes["左つま先"][60]["左ひざ"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.747242, 2.529942, -1.331971]),
        bone_matrixes["左つま先"][60]["左足首"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.809291, 0.242514, -1.182168]),
        bone_matrixes["左つま先"][60]["左つま先"].position.vector,
        rtol=0.02,
        atol=0.02,
    ).all()
    assert np.isclose(
        np.array([2.263363, 7.061642, -3.837192]),
        bone_matrixes["左足先EX"][60]["左ひざD"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.916109, 1.177077, -1.452845]),
        bone_matrixes["左足先EX"][60]["左足先EX"].position.vector,
        rtol=0.1,
        atol=0.1,
    ).all()
...
def test_read_by_filepath_ok_leg_ik5() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes["右つま先"][7409]["下半身"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-8.637265, 10.835548, -4.326830]),
        bone_matrixes["右つま先"][7409]["右足"].position.vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-8.693436, 7.595280, -7.321638]),
        bone_matrixes["右つま先"][7409]["右ひざ"].position.vector,
        rtol=0.3,
        atol=0.3,
    ).all()
    assert np.isclose(
        np.array([-7.521027, 2.827226, -9.035607]),
        bone_matrixes["右つま先"][7409]["右足首"].position.vector,
        rtol=0.3,
        atol=0.3,
    ).all()
    assert np.isclose(
        np.array([-7.453236, 0.356456, -8.876783]),
        bone_matrixes["右つま先"][7409]["右つま先"].position.vector,
        rtol=0.3,
        atol=0.3,
    ).all()
