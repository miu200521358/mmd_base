...
def test_read_by_filepath_ok_matrix() -> None:
    ...
    assert np.isclose(
        np.array([0, 0, 0]),
        bone_matrixes.position(10, "全ての親").vector,
    ).all()
    assert np.isclose(
        np.array([0.044920, 8.218059, 0.069347]),
        bone_matrixes.position(10, "センター").vector,
    ).all()
    assert np.isclose(
        np.array([0.044920, 9.392067, 0.064877]),
        bone_matrixes.position(10, "グルーブ").vector,
    ).all()

    assert np.isclose(
        np.array([0.044920, 11.740084, 0.055937]),
        bone_matrixes.position(10, "腰").vector,
    ).all()
    assert np.isclose(
        np.array([0.044920, 12.390969, -0.100531]),
        bone_matrixes.position(10, "上半身").vector,
    ).all()
    assert np.isclose(
        np.array([0.044920, 13.803633, -0.138654]),
        bone_matrixes.position(10, "上半身2").vector,
    ).all()
    assert np.isclose(
        np.array([0.044920, 15.149180, 0.044429]),
        bone_matrixes.position(10, "上半身3").vector,
    ).all()
    assert np.isclose(
        np.array([0.324862, 16.470263, 0.419041]),
        bone_matrixes.position(10, "左肩P").vector,
    ).all()
    assert np.isclose(
        np.array([0.324862, 16.470263, 0.419041]),
        bone_matrixes.position(10, "左肩").vector,
    ).all()
    assert np.isclose(
        np.array([1.369838, 16.312170, 0.676838]),
        bone_matrixes.position(10, "左腕").vector,
    ).all()
    assert np.isclose(
        np.array([1.845001, 15.024807, 0.747681]),
        bone_matrixes.position(10, "左腕捩").vector,
    ).all()
    assert np.isclose(
        np.array([2.320162, 13.737446, 0.818525]),
        bone_matrixes.position(10, "左ひじ").vector,
    ).all()
    assert np.isclose(
        np.array([2.516700, 12.502447, 0.336127]),
        bone_matrixes.position(10, "左手捩").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.732219, 11.267447, -0.146273]),
        bone_matrixes.position(10, "左手首").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.649188, 10.546797, -0.607412]),
        bone_matrixes.position(10, "左人指１").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.408238, 10.209290, -0.576288]),
        bone_matrixes.position(10, "左人指２").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.360455, 10.422402, -0.442668]),
        bone_matrixes.position(10, "左人指３").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    ...
    assert np.isclose(
        np.array([0, 0, 0]),
        bone_matrixes.position(999, "全ての親").vector,
    ).all()
    assert np.isclose(
        np.array([-0.508560, 8.218059, 0.791827]),
        bone_matrixes.position(999, "センター").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.508560, 9.182008, 0.787357]),
        bone_matrixes.position(999, "グルーブ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(999, "腰").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.508560, 12.180910, 0.621949]),
        bone_matrixes.position(999, "上半身").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.437343, 13.588836, 0.523215]),
        bone_matrixes.position(999, "上半身2").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    # 付与親
    assert np.isclose(
        ...
        bone_matrixes.position(999, "上半身3").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.590927, 16.312325, 0.819156]),
        bone_matrixes.position(999, "左肩P").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.590927, 16.312325, 0.819156]),
        bone_matrixes.position(999, "左肩").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.072990, 16.156742, 1.666761]),
        bone_matrixes.position(999, "左腕").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.043336, 15.182318, 2.635117]),
        bone_matrixes.position(999, "左腕捩").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.013682, 14.207894, 3.603473]),
        bone_matrixes.position(999, "左ひじ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.222444, 13.711100, 3.299384]),
        bone_matrixes.position(999, "左手捩").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.431205, 13.214306, 2.995294]),
        bone_matrixes.position(999, "左手首").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([3.283628, 13.209089, 2.884702]),
        bone_matrixes.position(999, "左人指１").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([3.665809, 13.070156, 2.797680]),
        bone_matrixes.position(999, "左人指２").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([3.886795, 12.968100, 2.718276]),
        bone_matrixes.position(999, "左人指３").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
...
def test_read_by_filepath_ok_leg_ik1() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(29, "下半身").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.368843, 10.614175, 2.532657]),
        bone_matrixes.position(29, "左足").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.983212, 6.945313, 0.487476]),
        bone_matrixes.position(29, "左ひざ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.345842, 2.211842, 2.182894]),
        bone_matrixes.position(29, "左足首").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-0.109262, -0.025810, 1.147780]),
        bone_matrixes.position(29, "左つま先").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
...
def test_read_by_filepath_ok_leg_ik2() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(3152, "下半身").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([7.370017, 10.665785, 2.963280]),
        bone_matrixes.position(3152, "左足").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([9.282883, 6.689319, 2.96825]),
        bone_matrixes.position(3152, "左ひざ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([4.115521, 7.276527, 2.980609]),
        bone_matrixes.position(3152, "左足首").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.931355, 6.108739, 2.994883]),
        bone_matrixes.position(3152, "左つま先").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
...
def test_read_by_filepath_ok_leg_ik3() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(60, "下半身").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.927524, 10.550287, -1.218106]),
        bone_matrixes.position(60, "左足").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.263363, 7.061642, -3.837192]),
        bone_matrixes.position(60, "左ひざ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.747242, 2.529942, -1.331971]),
        bone_matrixes.position(60, "左足首").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.809291, 0.242514, -1.182168]),
        bone_matrixes.position(60, "左つま先").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.263363, 7.061642, -3.837192]),
        bone_matrixes.position(60, "左ひざD").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.916109, 1.177077, -1.452845]),
        bone_matrixes.position(60, "左足先EX").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
...
def test_read_by_filepath_ok_leg_ik4() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(0, "下半身").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.175478, 10.780540, 2.728409]),
        bone_matrixes.position(0, "右足").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([0.950410, 11.256771, -1.589462]),
        bone_matrixes.position(0, "右ひざ").vector,
        rtol=0.2,
        atol=0.2,
    ).all()
    assert np.isclose(
        np.array([-1.025194, 7.871110, 1.828258]),
        bone_matrixes.position(0, "右足首").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-1.701147, 6.066556, 3.384271]),
        bone_matrixes.position(0, "右つま先").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
...
def test_read_by_filepath_ok_leg_ik5() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(7409, "下半身").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-8.637265, 10.835548, -4.326830]),
        bone_matrixes.position(7409, "右足").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([-8.693436, 7.595280, -7.321638]),
        bone_matrixes.position(7409, "右ひざ").vector,
        rtol=0.3,
        atol=0.3,
    ).all()
    assert np.isclose(
        np.array([-7.521027, 2.827226, -9.035607]),
        bone_matrixes.position(7409, "右足首").vector,
        rtol=0.3,
        atol=0.3,
    ).all()
    assert np.isclose(
        np.array([-7.453236, 0.356456, -8.876783]),
        bone_matrixes.position(7409, "右つま先").vector,
        rtol=0.3,
        atol=0.3,
    ).all()
...
def test_read_by_filepath_ok_arm_ik() -> None:
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(10, "左腕YZ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.611640, 15.785284, -0.086812]),
        bone_matrixes.position(10, "左腕捩YZ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([1.611641, 15.785284, -0.086812]),
        bone_matrixes.position(10, "左腕捩X").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.321083, 13.811781, 0.016998]),
        bone_matrixes.position(10, "左ひじYZ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.414732, 13.218668, -0.214754]),
        bone_matrixes.position(10, "左手捩YZ").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.414731, 13.218668, -0.214755]),
        bone_matrixes.position(10, "左手捩X").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.620196, 11.955698, -0.693675]),
        bone_matrixes.position(10, "左手捩6").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.691600, 11.503933, -0.870235]),
        bone_matrixes.position(10, "左手首R").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
        np.array([2.633156, 11.364628, -0.882837]),
        bone_matrixes.position(10, "左手首2").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
    assert np.isclose(
    ...
    assert np.isclose(
        ...
        bone_matrixes.position(10, "左人指先").vector,
        rtol=0.01,
        atol=0.01,
    ).all()
